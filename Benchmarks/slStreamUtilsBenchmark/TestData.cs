...
namespace slStreamUtilsBenchmark
{
    ...
    [MessagePackObject, ProtoContract]
    public class TestClassSmall1 : IEquatable<TestClassSmall1>, IDoStuff, IAmRandomInstantiable<TestClassSmall1>, IMeasureSizeWithAllignmentPadding
    {
        [ProtoMember(1), Key(0)]
        public bool b1;
        [ProtoMember(2), Key(1)]
        ...
        public TestClassSmall1 GetRandInstance(RandHelper helper, params int[] lengths)
        {
            TestClassSmall1 res = new TestClassSmall1();
            helper.GetRand(out res.b1);
            res.ss1 = new TestStructSmall1().GetRandInstance(helper);
        ...
        public bool Equals([DisallowNull] TestClassSmall1 other)
        {
            return
                other.b1 == b1 &&
                other.ss1.Equals(ss1) &&
    ...
    [MessagePackObject, ProtoContract]
    public class TestClassLarge1 : IEquatable<TestClassLarge1>, IDoStuff, IAmRandomInstantiable<TestClassLarge1>, IMeasureSizeWithAllignmentPadding
    {
        [ProtoMember(3), Key(2)]
        public bool b1;
        [ProtoMember(4), Key(3)]
        ...
        public TestClassLarge1 GetRandInstance(RandHelper helper, params int[] lengths)
        {
            TestClassLarge1 res = new TestClassLarge1();
            helper.GetRand(out res.b1);
        ...
        public bool Equals([DisallowNull] TestClassLarge1 other)
        {
            return
                other.b1 == b1 &&
